...
<!-- RENVOYER VERS L’ARTICLE RÉDIGÉ PAR @FRANÇOISE --> 

La plateforme peut désormais assembler et vérifier la conformité des différents PDFs, sans qu’ils soient mis bout à bout !
...
Une dématérialisation/digitalisation des différents documents afférents au RFI est intéressante parce qu’avec notre solution #paxpartech, un simple 'drag & drop' ('glisser-déposer') du dossier complet va permettre de rapprocher les données associées aux différents documents, de les comparer, de les confronter et donc de signaler :
...
L’écart constaté ? ➡️ un document a été joint au DSI, mais n’est pas listé dans la LDA.
...
![ici](https://paxpar.tech/fr/blog/article_demo1)
...
<!-- L'article concerné est pour le moment rangé dans pp-ref, il a été rédigé par @Nadine --> 
...
<!-- 20240704 ce pdf n'existe pas encore -->
...
Non seulement le support en lui-même, mais également la transmission des documents sous cette forme, d'un service à un autre, peut poser question
➡️ il y a des risques pour l'intégrité et la conformité de ces documents.

paxpartech a opté pour une dématérialisation/digitalisation du dossier RFI :
